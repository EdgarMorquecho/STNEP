function [resistencia_total, reactancia_total, susceptancia_total, limite_flujo]=Topologia_Red(~,x_posicion,sistema,...
~,~)
...
%% Lectura de los parametros del sistema sin lineas adicionadas
...
limite_inicial=mpc.branch(:,6); % Lectura del limite de potencia de cada derecho de transmision
limite_flujo=x_posicion(1:numero_ramas,:).*limite_inicial; %multiplica el numero de lineas de la topologia actual por su límite de potencia, dando el limite de flujo total por derecho de transmisión
   ...
   clearvars -except resistencia_total reactancia_total susceptancia_total limite_flujo...
       i x_posicion sistema Qp Lineas_ano SS n_anos
